...
* [Staging workspace registered model](https://e2-demo-tokyo.cloud.databricks.com#mlflow/models/staging-mlops-jetstar-model)
* [Prod workspace registered model](https://cse2.cloud.databricks.com#mlflow/models/prod-mlops-jetstar-model)
