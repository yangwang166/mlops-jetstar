resource "databricks_job" "write_feature_table_job" {
  name = "${local.env_prefix}mlops-jetstar-write-feature-table-job"
  ...
  task {
    ...
    notebook_task {
      ...
      base_parameters = {
        ...
        output_table_name         = "jetstar_feature_store_taxi_example.trip_pickup_features_staging"
  ...
  task {
    ...
    notebook_task {
      ...
      base_parameters = {
        ...
        output_table_name         = "jetstar_feature_store_taxi_example.trip_dropoff_features_staging"
